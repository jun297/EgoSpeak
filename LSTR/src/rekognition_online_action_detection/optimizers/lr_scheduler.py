...
class DummyScheduler:
    ...
    def step(self):
        pass  # No operation for stepping the scheduler
...
def build_scheduler(cfg, optimizer, num_iters_per_epoch):
    ...
    if cfg.SOLVER.SCHEDULER.SCHEDULER_NAME == 'none' or cfg.SOLVER.SCHEDULER.SCHEDULER_NAME is None:
        scheduler = DummyScheduler(optimizer)
    
    elif cfg.SOLVER.SCHEDULER.SCHEDULER_NAME == 'multistep':
