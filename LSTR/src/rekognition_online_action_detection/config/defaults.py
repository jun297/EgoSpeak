...
_C.MODEL.MODEL_NAME = ''
_C.MODEL.CHECKPOINT = ''
_C.MODEL.EXCEPT_CLASSIFIER = False
...
# _C.MODEL.MINIROAD.NUM_WORKERS = 4
...
# _C.MODEL.MINIROAD.LR = 0.0001
# _C.MODEL.MINIROAD.WEIGHT_DECAY = 0.05
...
_C.SOLVER.SCHEDULER.SCHEDULER_NAME = None
...
_C.SOLVER.SAVE_EVERY_EPOCHS = 10
